...
public class CreatureManager {
    ...
    public boolean SetActiveAnimationName(String name_in, boolean check_already_set) {
        ...
        Vector<MeshDisplacementCache> displacement_table =
        ...
        Vector<MeshUVWarpCache> uv_swap_table =
        ...
        Vector<MeshRenderRegion> all_regions = render_composition.getRegions();
    ...
    public void SetShouldLoop(boolean flag_in) {
        should_loop = flag_in;
    }
